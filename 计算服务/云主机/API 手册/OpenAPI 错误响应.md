...
## 错误码
    ...
    4000700 Invalid Header parameters
    4000701 Invalid parameters
    4000702 Missing parameters
    4000704 instance info error.
    4000705 no such tenant id
    4000706 incapable opeartion
    4000707 pagesize or pagenum error
    4000708 os type error : only linux or windows
    4000709 public ip already mounted or portid invalid
    4000710 package server is NOT allowed to be deleted
    4000711 invalid cpu or memory or ssd
    4000712 invalid instance name
    4000713 invalid image id
    4000714 invalid sshkeynames or adminpassword
    4000715 virtual server count over quota
    4090715 duplicated instance name
    4000716 invalid qosMode parameters
    4000717 ip backend service status error
    4000718 invalid bill info
    4000719 invalid virtual server description
    4000720 instance status error
    4000721 duplicated image name
    4000722,    image uploading conflict
    4000723 no such imageId
    4000724 instance based the image exist
    4000725 can not delete public image
    4000726 duplicated attach
    4000727 volumes attach oversize
    4000728 volumes attach low-level error (raw format or cinder error
    4000729 no such volume
    4000797 Please retry
    4000798 No Permission
    4000799 unkown error
    ...
    5000599 VirtualServer internal server error
    5000703 Create Server Internal Error.
