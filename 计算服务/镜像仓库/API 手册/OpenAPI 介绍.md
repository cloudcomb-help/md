...
蜂巢 API 需要使用 API Token 来发起 API 请求。 请到 https://c.163.com 页面登录到你的账户，查看你的 Access Key 和 Access Secret，然后调用 [生成 API token 接口](http://support.c.163.com/md.html#!计算服务/容器服务/API 手册/用户 API.md) 来获取 token。
