...
除上述通过VNC控制台 + 密码登录的方法之外，还可以通过远程连接的方式登录云主机。
...
关于如何使用VPN，可以参考 [如何使用蜂巢OpenVPN](http://support.c.163.com/md.html#!容器服务/服务管理/使用技巧/如何使用蜂巢 OpenVPN.md)
...
* 如果您是从网易蜂巢提供的基础镜像恢复的云主机，则Windows系统的管理员登录密码会改变，需要重新设置。请使用设置云主机页面修改登录密码。之后才可使用远程连接登录云主机。
